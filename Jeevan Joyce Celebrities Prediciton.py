...
root_dir = 'C:/Users/Jeevan Joyce/Desktop/deep learning/Dataset_Celebrities/cropped'
...
history = model.fit(x_train, y_train, epochs=240, batch_size=128, validation_split=0.1)
...
plt.savefig(r'C:\Users\Jeevan Joyce\Desktop\deep learning\Dataset_Celebrities\Results\accuracy_plot.png')
...
plt.savefig(r'C:\Users\Jeevan Joyce\Desktop\deep learning\Dataset_Celebrities\Results\loss_plot.png')
